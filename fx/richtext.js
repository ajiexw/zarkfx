FX.getFrame('jquery-1.3.2', function($){
    ...
    FX.run('richtext', function(attrs){
        ...
        $this.tinymce({
            ...
            theme_advanced_buttons1 : "bold,italic,underline,strikethrough,|,justifyleft,justifycenter,justifyright,justifyfull,|,fontsizeselect,forecolor,backcolor,styleprops,removeformat,|,code,hr,link,unlink,undo,redo,sparker5image",
